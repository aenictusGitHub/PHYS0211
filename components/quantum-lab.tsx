    ...
    const registration = context.registerTool(
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            fourierChirp: { type: 'number', minimum: -2, maximum: 2, description: 'Coefficient c sans dimension. En SI : Δp=hbar sqrt(1+c²)/(2 sigma).' },
