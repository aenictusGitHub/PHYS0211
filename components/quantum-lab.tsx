    ...
    const registration = context.registerTool(
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            fourierSigma: { type: 'number', minimum: FOURIER_SIGMA_MIN, maximum: FOURIER_SIGMA_MAX, description: 'Écart-type en position du paquet gaussien, hbar=1.' },
            fourierCenter: { type: 'number', minimum: -FOURIER_CENTER_LIMIT, maximum: FOURIER_CENTER_LIMIT },
