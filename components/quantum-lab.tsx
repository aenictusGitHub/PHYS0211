    ...
    const registration = context.registerTool(
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            fourierWindow: { type: 'number', minimum: 5, maximum: 400, description: 'Demi-largeur de la fenêtre en position en nm ; jamais ajustée automatiquement.' },
            fourierMomentumWindow: { type: 'number', minimum: 1, maximum: 100, description: 'Demi-largeur en impulsion en 10^-25 kg m/s, défaut 40 ; indépendante de la physique et du temps.' },
